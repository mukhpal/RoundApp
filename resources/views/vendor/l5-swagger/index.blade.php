...
window.onload = function() {
  ...
  const ui = SwaggerUIBundle({
    ...
    var clientId = "{{config('l5-swagger.security.passport.flows.password.client_id')}}";
    var secret = "{{config('l5-swagger.security.passport.flows.password.secret')}}";
    ui.initOAuth({
        clientId: clientId,
        clientSecret: secret
    });
